...
export const en = {
    ...
    items: [
      {
        ...
        imageFallback: '/images/david-philips-solo.png',
        imageAlt: 'Intimate live guitar and vocals — refined atmosphere for a tasting or cocktail reception.',
      },
      {
      ...
      },
      {
        ...
        image: '/images/experiences/showroom.jpg',
        imageFallback: '/images/abel-boquera.png',
        imageAlt: 'Hammond organ and drums duo — distinctive live sound for a showroom or product moment.',
      },
      {
      ...
      },
      {
        ...
        image: '/images/experiences/gala-dinner.jpg',
        imageFallback: '/images/sinead-live.jpg',
        imageAlt: 'Soul vocalist performing live — elegant presence for a gala dinner or awards evening.',
      },
      {
        title: 'Brand evening',
        ...
        image: '/images/experiences/brand-evening.jpg',
        imageFallback: '/images/shu-shus-trio.png',
        imageAlt: 'Soul-jazz instrumental trio — stylish groove for cocktails through to a fuller evening.',
      },
    ],
  },
  caseStudies: {
    title: 'Recent work',
    intro:
      'A sample of corporate and international events we have shaped musically — from Switzerland to Barcelona showrooms, fairs and gala evenings. Client names available on request where confidentiality applies.',
    cta: 'Discuss your event',
    items: [
      {
        type: 'Team-building & off-site',
        title: 'International company retreat',
        location: 'Switzerland',
        format: 'Soul-jazz trio · full day',
        body: 'Multi-session live music for an international off-site: welcome groove, interactive afternoon set and softer background during dinner. Briefing and communication in English with the client’s event lead.',
        highlight: 'Participation without “forced fun” — the band carried the energy.',
      },
      {
        type: 'Showroom & product presentation',
        title: 'Audio brand showroom demo',
        location: 'Barcelona area',
        format: 'Organ trio · reveal sting',
        body: 'Live soul-jazz for a showroom walk-through: understated background during demos, then a confident musical lift for the product moment. Coordinated with the brand’s technical team and tight timings.',
        highlight: 'Music matched the premium, engineered feel of the space.',
      },
      {
        type: 'Trade fair & congress',
        title: 'Exhibition networking lounge',
        location: 'Catalonia',
        format: 'Duo · welcome & breaks',
        body: 'Repeated short sets for a fair networking zone — consistent volume for conversation, punctual changeovers between sessions, easy coordination with organisers.',
        highlight: 'Reliable blocks for a busy trade schedule.',
      },
      {
        type: 'Trade fair & congress',
        title: 'Congress welcome & coffee breaks',
        location: 'Barcelona',
        format: 'Solo piano to trio',
        body: 'Live jazz for international delegates between sessions: clear communication with AV, adaptable dynamics for a large hall, repertoire suited to a mixed European audience.',
        highlight: 'English and Spanish with planners and venue staff.',
      },
      {
        type: 'Award ceremony & gala dinner',
        title: 'Corporate gala dinner',
        location: 'Barcelona · 120+ guests',
        format: 'Voice-led quartet · ceremony + dinner',
        body: 'Entrance music, discreet support through speeches and awards, then a fuller soul-jazz feel for the meal. Cues agreed in advance with the master of ceremonies.',
        highlight: 'Calm when needed, lift for the room after the formalities.',
      },
      {
        type: 'Wine & spirits tasting',
        title: 'Private winery tasting',
        location: 'Penedès',
        format: 'Duo · guitar & vocals',
        body: 'Refined background between pours — guests could talk easily while the room still felt special. Optional shorter sets between tasting rounds.',
        highlight: 'Volume curated for conversation, not performance overload.',
      },
    ],
  },
  formats: {
  ...
  liveClips: {
    ...
    items: [
      ...
      { title: 'With vocalist — voice & band', youtubeId: '4BrkJO9TEQE' },
      { title: 'Celebration — live + DJ atmosphere', youtubeId: '3G8Tsb0clSk' },
    ],
  },
  moments: {
  ...
  contact: {
    ...
    fields: {
      ...
      location: 'Venue / city',
      type: 'Type of event',
      moment: 'Ceremony / cocktail / dinner / party',
      guests: 'Approx. number of guests',
      format: 'Preferred format (if you know)',
      message: 'Message',
    },
    placeholders: {
      name: 'Your name',
      ...
      message: 'Timings, musical wishes, languages spoken…',
    },
    submit: 'Send enquiry',
    mailtoNote: 'Prefer email?',
